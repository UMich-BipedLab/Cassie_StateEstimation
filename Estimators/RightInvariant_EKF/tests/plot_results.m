...
% Trim True
R_true = R_true(:,:,startIndex:endIndex);
q_true = q_true(:,startIndex:endIndex);
v_true = v_true(:,startIndex:endIndex); 
vb_true = vb_true(:,startIndex:endIndex);
p_true = p_true(:,startIndex:endIndex);
dR_true = dR_true(:,startIndex:endIndex);
dL_true = dL_true(:,startIndex:endIndex);
for i=1:length(lm_true)
    lm_true{i} = lm_true{i}(:,startIndex:endIndex);
end
bg_true = bg_true(:,startIndex:endIndex);
ba_true = ba_true(:,startIndex:endIndex);
