#ifndef __MH1YGGHXm7BJTN0FViiwM_h__
#define __MH1YGGHXm7BJTN0FViiwM_h__
...
#include <stdlib.h>
#ifndef struct_tag_sFOr6MqxDqyS5zSjqEqyzOE
#define struct_tag_sFOr6MqxDqyS5zSjqEqyzOE

struct tag_sFOr6MqxDqyS5zSjqEqyzOE
{
...
#endif                                 /*struct_tag_sFOr6MqxDqyS5zSjqEqyzOE*/

#ifndef typedef_RIEKF
#define typedef_RIEKF

typedef struct tag_sFOr6MqxDqyS5zSjqEqyzOE RIEKF;
...
#ifndef typedef_InstanceStruct_MH1YGGHXm7BJTN0FViiwM
#define typedef_InstanceStruct_MH1YGGHXm7BJTN0FViiwM

typedef struct {
  SimStruct *S;
  RIEKF sysobj;
  boolean_T sysobj_not_empty;
  real_T BigX_data[291600];
  ...
  real_T b_y0_data[11449];
  real_T c_tmp_data[11449];
  real_T F_data[10164];
  real_T h_C_data[10164];
  real_T f_y_data[10164];
  real_T Pa_data[6561];
  real_T b_Pa_data[6561];
  real_T c_Pa_data[6561];
  real_T I_data[6561];
  real_T b_varargin_1_data[5625];
  real_T K_data[4860];
  real_T b_BigX_data[291600];
  real_T c_b_data[128400];
  real_T c_a_data[48400];
  real_T g_y_data[48400];
  ...
  real_T m_y_data[25894];
  real_T i_C_data[25894];
  real_T j_C_data[25894];
  real_T c_varargin_1_data[22898];
  real_T d_varargin_1_data[22898];
  real_T d_tmp_data[14641];
  real_T k_C_data[14641];
  real_T e_tmp_data[11449];
  real_T d_Pa_data[6561];
  real_T b_I_data[6561];
  real_T d_b_data[128400];
  real_T Lc_data[103041];
  real_T f_tmp_data[99225];
  real_T d_a_data[48400];
  real_T n_y_data[48400];
  ...
  real_T t_y_data[38841];
  real_T Fc_data[14641];
  real_T Fk_data[14641];
  real_T g_tmp_data[13225];
  real_T h_tmp_data[11449];
  real_T i_tmp_data[10000];
  real_T c_BigX_data[291600];
  real_T e_b_data[128400];
  real_T e_a_data[48400];
  real_T u_y_data[48400];
  real_T v_y_data[48400];
  real_T w_y_data[48400];
  real_T x_y_data[48400];
  real_T c_Xa_data[38841];
  real_T j_tmp_data[14641];
  real_T k_tmp_data[11449];
  real_T b_PI_data[8400];
  real_T e_Pa_data[6561];
  real_T c_I_data[6561];
  real_T y_y_data[6561];
  real_T ab_y_data[6561];
  real_T l_C_data[6561];
  real_T m_C_data[6561];
  real_T b_K_data[4860];
  real_T A_data[4860];
  real_T l_tmp_data[4860];
  real_T B_data[4860];
  real_T N_data[3600];
  real_T d_BigX_data[291600];
  real_T f_b_data[128400];
  real_T f_a_data[48400];
  real_T bb_y_data[48400];
  real_T cb_y_data[48400];
  real_T db_y_data[48400];
  real_T d_Xa_data[38841];
  real_T m_tmp_data[14641];
  real_T n_tmp_data[11449];
  real_T eb_y_data[10164];
  real_T fb_y_data[10164];
  real_T gb_y_data[10164];
  real_T hb_y_data[10164];
  real_T ib_y_data[9801];
  real_T f_Pa_data[6561];
  real_T d_I_data[6561];
  real_T varargin_2_data[4860];
...
#endif                                 /*typedef_InstanceStruct_MH1YGGHXm7BJTN0FViiwM*/
...
extern void method_dispatcher_MH1YGGHXm7BJTN0FViiwM(SimStruct *S, int_T method,
  void* data);
