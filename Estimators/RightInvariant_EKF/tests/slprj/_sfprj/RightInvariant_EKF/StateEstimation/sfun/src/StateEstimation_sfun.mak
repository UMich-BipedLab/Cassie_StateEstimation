...
MODEL     = StateEstimation
TARGET      = sfun
MODULE_SRCS   = c21_StateEstimation.c c41_StateEstimation.c c42_StateEstimation.c
MODEL_SRC  = StateEstimation_sfun.c
MODEL_REG = 
MAKEFILE    = StateEstimation_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Ross Hartley\Documents\GitHub\Ross_Cassie_Controllers\submodules\Cassie_StateEstimation\Estimators\RightInvariant_EKF\tests\slprj\_sfprj\RightInvariant_EKF\StateEstimation\sfun\src" 
...
OBJLIST_FILE = StateEstimation_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
